...
Detailed python code for sizing can be found in *Appendix - C* and [here](https://github.com/ptoyni/thesis_hp/tree/main/sizing/python)
:::
...
![OTA design in Xschem](../figures/_fig_foldedcascode_xschem.pdf){#fig-foldedcascode-xschem height="100%"}

Please find the schematic design [here](../Designs/otas/1_schematics/foldedcascode_nmos.sch)`../Designs/otas/1_schematics/foldedcascode_nmos.sch`
...
and Tian's method as mention in @fig-ac-xschem, @fig-tran-xschem, @fig-loopgain-xschem-tian and @fig-loopgain-xschem-mb

<!-- ![AC Analysis Setup](../figures/_fig_ac.svg){#fig-ac-xschem format=html}
![AC Analysis Setup](../figures/_fig_ac.pdf){#fig-ac-xschem format=pdf} -->


::: {#fig-ac-xschem .figure .no-float}
![AC Analysis Setup](../figures/_fig_ac.svg){format=html}
![AC Analysis Setup](../figures/_fig_ac.pdf){format=pdf}{width=100%}
...
::: callout-note 
# ngspice code for ac analysis setup
...
![Transient Analysis Setup](../figures/_fig_tran.pdf){#fig-tran-xschem width=100%}

The testbench setup with ngspice code is included in the schematic\newline 
`./Designs/otas/1_schematics/tb_foldedcascode_nmos_ac.sch`

::: callout-note 
# ngspice code for transient analysis setup
...
![Loop Gain Setup Tian](../figures/_fig_loopgain_tian.pdf){#fig-loopgain-xschem-tian}
![Loop Gain Setup MiddleBrook](../figures/_fig_loopgain_mb.pdf){#fig-loopgain-xschem-mb}
The testbench setup with ngspice code is included in the schematic\newline
`./Designs/otas/1_schematics/tb_foldedcascode_nmos_loopgain.sch`
