...
[here](https://github.com/iic-jku/analog-circuit-design/blob/main/sizing/Ref_Murmann_gmID.pdf)
...
![AC Analysis Output](../figures/_fig_foldedcascode_ac_bode.svg.svg){#fig-ac-output-xschem}
...
[CACE](https://github.com/efabless/cace) in this lecture. CACE is written in Python and allows to setup a datasheet in
...
There is a CACE setup available for our 5T-OTA. The [datasheet](../cace/foldedcascode_nmos.yaml) describes the operating
...
| Supply current (as low as possible)        | $<12.5$ | µA      |
| Turn-on time                               | $<0.4$  | µs      |
