...
Available KLayout PEX Engines[@kpex]:
<!-- 
...
| `KPEX/2.5D`        | R            | Planned                 | Prototype engine implementing MAGIC concepts/formulas with `KLayout` means       | -->

::: {.tbl-colwidths="[0.18,0.12,0.15,0.55]"}
| Engine          | PEX Type  | Status              | Description                                              |
|-----------------|-----------|---------------------|----------------------------------------------------------|
| KPEX/MAGIC      | CC, RC    | Usable              | Wrapper engine, using installed magic tool               |
| KPEX/FasterCap  | Cp        | Usable, pending QA  | Field solver engine using FasterCap                      |
| KPEX/FastHenry2 | R, L      | Planned             | Field solver engine using FastHenry2                     |
| KPEX/2.5D       | CC        | Under construction  | Prototype engine implementing MAGIC formulas in KLayout  |
| KPEX/2.5D       | R         | Under construction  | Prototype engine implementing MAGIC formulas in KLayout  |
:::


## Running the [`KPEX/MAGIC` Engine](https://iic-jku.github.io/klayout-pex-website/doc/doc.html#sec-kpex-magic)[@kpex]
