...
![Macro Development interface with DRC Results in Console](../figures/_fig_macro_devs.svg){#fig-macro-dev}
...
To use the script, simply copy the DRC Errors from console output from KLayout, paste it into the terminal running the Python program, and the script will generate a concise summary of the errors that remain to be corrected manually in the layout. This script could also be found in *Appendix - C*.
