...
After completing device-level layout, parasitic-aware routing, and full DRC/LVS verification, the final stage of physical design is the construction of the **pad frame** and the **seal ring**. These structures are the physical interface between the silicon die and the outside world. Although electrically simple, they are mechanically and parasitically critical, as they determine whether the fabricated chip can be safely diced, bonded, packaged, and measured.   
...
Beyond its mechanical role, the seal ring also acts as a **low-impedance electrical shield**[@lienig2020], tied to AVSS, providing:
...
- confinement of parasitic surface currents.[@lienig2020]
...
Bond pads form the electrical interface between the on-chip metal layers and the external package or measurement environment. Each pad is a large, top-metal landing area with a passivation opening, designed to withstand mechanical bonding forces while maintaining low series resistance.  
...
The placement of pads was also optimized to minimize parasitic capacitive coupling to the underlying analog core. Pads were spaced to avoid long parallel overlaps with internal routing, and their distribution was balanced to avoid asymmetries in substrate stress and top-metal loading.[@lienig2020]
...
These requirements go beyond the scope of this prototype analog OTA; therefore, flip-chip pads were not used.


##  Pad Geometry: Orthogonal vs. Square Pads

Bond pad geometry influences both mechanical reliability and parasitic loading. @lienig2020 mentions classical square pads are straightforward but can concentrate mechanical stress at their sharp corners during bonding. To mitigate this, the SG13G2 PDK also offers **orthogonal (octagonal) pads**, which soften corner transitions and distribute force more evenly across the pad boundary.
...
::: {#fig-final_layout.figure}
![](../figures/_fig_full_chip.pdf){height="100%"}

Final NMOS-OTA Chip Layout with Bondpads, ESD Diodes and Metal Fillers around the core block before final density fillers.  
:::
