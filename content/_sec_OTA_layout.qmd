...
## 6. Finger Count Estimation (Minimum Number of Fingers)
...
### 6.3 Junction Capacitance Model
...
### 6.5 Example (OTA Tail Transistor)
...
{{< embed ../layout_scripts/cal_min_fingers_ng.py echo=true >}}
:::
