...
When certain layout geometries or biasing conditions bring these devices into proximity, they can create an unintended path between the power rails (AVDD and AVSS). A transient event such as an electrostatic discharge, substrate noise spike, or voltage overshoot can trigger this path, producing a **low-impedance short** between supply and ground.  
