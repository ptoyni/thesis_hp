...
- **Design Goal**: Develop a high-gain, low-offset error amplifier suitable for the feedback loop in a buck converter 
  topology, ensuring accurate voltage regulation and stable control performance. 

#### Design and Simulation Workflow

1. **Circuit Design**
	A high-gain, low-offset operational amplifier is designed using a two-stage architecture, optimized for low power and
	high common-mode rejection. Key specifications include: 
	- Gain > 80 dB
	- Offset voltage < 2 mV
...
5. **GDSII Generation**
   A validated GDSII file is generated for MPW (Multi-Project Wafer) tapeout submission through the IIC-OSIC shuttle,
   targeting integration into the full mixed-signal LED driver IC.
