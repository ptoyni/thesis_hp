...
"}
C {devices/vsource.sym} 690 -210 0 0 {name=Vdd value=1.45
}
...
C {devices/vsource.sym} 870 -420 0 0 {name=Vin value="dc 0.8 ac 1"}
C {lab_wire.sym} 930 -540 0 0 {name=p4 sig_type=std_logic lab=v_in}
C {isource.sym} 1070 -620 0 0 {name=I0 value= 17.4u}
...
C {devices/code_shown.sym} 80 -560 0 0 {name=NGSPICE1 only_toplevel=true 
value="
.temp -40
