...
N 1410 -500 1450 -500 {lab=v_dd}
N 1410 -500 1410 -360 {lab=v_dd}
...
N 2170 -500 2210 -500 {lab=v_dd}
N 2170 -500 2170 -360 {lab=v_dd}
...
N 1410 -1060 1450 -1060 {lab=v_dd}
N 1410 -1060 1410 -920 {lab=v_dd}
N 1450 -980 1450 -960 {lab=#net7}
N 1170 -850 1330 -850 {lab=vmeas1}
N 1410 -800 1410 -700 {lab=v_ss}
...
N 1410 -800 1430 -800 {lab=v_ss}
N 1430 -840 1430 -800 {lab=v_ss}
N 1500 -880 1570 -880 {lab=#net6}
N 1410 -920 1430 -920 {lab=v_dd}
N 1280 -880 1330 -880 {lab=#net7}
N 1280 -960 1280 -880 {lab=#net7}
N 1280 -960 1450 -960 {lab=#net7}
N 2260 -880 2330 -880 {lab=#net8}
N 2190 -840 2190 -800 {lab=v_ss}
N 2170 -800 2190 -800 {lab=v_ss}
N 2170 -920 2190 -920 {lab=v_dd}
N 2040 -880 2090 -880 {lab=#net9}
N 2040 -960 2040 -880 {lab=#net9}
N 2040 -960 2210 -960 {lab=#net9}
N 1410 -360 1430 -360 {lab=v_dd}
N 1410 -280 1430 -280 {lab=v_ss}
N 1410 -280 1410 -140 {lab=v_ss}
N 2170 -280 2170 -140 {lab=v_ss}
N 2170 -280 2190 -280 {lab=v_ss}
N 2170 -360 2190 -360 {lab=v_dd}
...
C {devices/lab_pin.sym} 1410 -500 0 0 {name=p5 sig_type=std_logic lab=v_dd}
...
C {devices/isource.sym} 1450 -450 0 0 {name=I1 value=10u pwl(0 0 10u 0 11u 10u)"}
...
C {devices/lab_pin.sym} 2170 -500 0 0 {name=p14 sig_type=std_logic lab=v_dd}
...
C {devices/isource.sym} 2210 -450 0 0 {name=I2 value=10u pwl(0 0 10u 0 11u 10u)"}
...
C {devices/lab_pin.sym} 1410 -1060 0 0 {name=p19 sig_type=std_logic lab=v_dd}
...
C {devices/isource.sym} 1450 -1010 0 0 {name=I3 value=10u pwl(0 0 10u 0 11u 10u)"}
C {devices/lab_pin.sym} 2170 -1060 0 0 {name=p26 sig_type=std_logic lab=v_dd}
...
C {devices/isource.sym} 2210 -1010 0 0 {name=I4 value=10u pwl(0 0 10u 0 11u 10u)"}
