...
N 930 -210 930 -170 {
lab=#net1}
N 490 -580 720 -580 {lab=v_dd}
N 860 -400 890 -400 {lab=#net2}
N 930 -580 1050 -580 {lab=out1}
N 930 -580 930 -550 {lab=out1}
N 930 -370 930 -270 {lab=#net3}
...
N 760 -140 790 -140 {
lab=v_gs}
N 720 -370 720 -170 {lab=#net4}
N 490 -580 490 -170 {lab=v_dd}
N 720 -580 720 -530 {lab=v_dd}
N 930 -450 930 -430 {lab=#net2}
N 860 -450 860 -400 {lab=#net2}
N 860 -450 930 -450 {lab=#net2}
N 930 -490 930 -450 {lab=#net2}
N 1050 -580 1050 -150 {lab=out1}
N 720 -450 720 -430 {lab=v_gs}
N 760 -400 860 -400 {lab=#net2}
N 720 -450 790 -450 {lab=v_gs}
N 720 -470 720 -450 {lab=v_gs}
N 790 -450 790 -140 {lab=v_gs}
...
C {devices/lab_pin.sym} 490 -580 0 0 {name=p2 sig_type=std_logic lab=v_dd}
...
C {devices/lab_pin.sym} 1050 -580 0 1 {name=p7 sig_type=std_logic lab=out1}
...
C {devices/ammeter.sym} 930 -520 0 0 {name=Viout2 savecurrent=true spice_ignore=0}
