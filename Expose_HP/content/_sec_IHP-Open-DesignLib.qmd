...
**IHP-Open-DesignLib** is an open-source IC design repository supporting the **SG13G2 BiCMOS** and **SG13CMOS**
processes from IHP. It enables the fabrication of non-commercial, academic, and research-based designs via free
Multi-Project Wafer (MPW) runs under the **FMD-QNC** project (project code: 16ME083, funded by the German government).

The platform promotes community-based development, tape-outs via GitHub submissions, and open access to prototype ICs
fabricated at IHP’s pilot line.
