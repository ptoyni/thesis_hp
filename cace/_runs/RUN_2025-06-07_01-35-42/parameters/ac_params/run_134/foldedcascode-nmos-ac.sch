...
echo $&op1.dcgain $&fbw > /foss/designs/thesis/workspace/thesis_hp/cace/_runs/RUN_2025-06-07_01-35-42/parameters/ac_params/run_134/foldedcascode-nmos-ac_134.data
.endc
"}
...
C {devices/vsource.sym} 1000 -440 0 0 {name=Vdd value=1.55}
C {devices/gnd.sym} 1000 -390 0 0 {name=l3 lab=GND}
C {lab_pin.sym} 1000 -480 0 0 {name=p2 sig_type=std_logic lab=v_dd}
C {devices/vsource.sym} 1250 -580 0 0 {name=Vin value="dc 0.9 ac 1"}
