...
C {devices/vsource.sym} 780 -470 0 0 {name=Vdd value=1.45}
C {devices/gnd.sym} 780 -420 0 0 {name=l3 lab=GND}
C {lab_pin.sym} 780 -510 0 0 {name=p2 sig_type=std_logic lab=v_dd}
C {devices/vsource.sym} 1030 -610 0 0 {name=Vin value=0.9}
...
echo $&tsettle > /foss/designs/thesis/workspace/thesis_hp/cace/_runs/RUN_2025-06-07_21-18-43/parameters/tran_params/run_123/foldedcascode-nmos-tran_123.data
.endc
"}
