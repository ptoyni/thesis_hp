...
C {devices/vsource.sym} 860 -230 0 0 {name=Vdd value=1.45}
C {devices/gnd.sym} 860 -180 0 0 {name=l3 lab=GND}
C {lab_pin.sym} 860 -270 0 0 {name=p2 sig_type=std_logic lab=v_dd}
C {devices/vsource.sym} 1110 -370 0 0 {name=Vin value="dc 0.9 ac 1"}
...
echo $&noise > /foss/designs/thesis/workspace/thesis_hp/cace/_runs/RUN_2025-06-07_01-16-52/parameters/noise_params/run_105/foldedcascode-nmos-noise_105.data
.endc
"}
